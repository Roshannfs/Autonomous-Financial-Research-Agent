...
# Page Configuration
st.set_page_config(page_title="Autonomous-Financial-Research-Agent", layout="wide")
...
if user_query:
    ...
    with st.spinner("ARA-1 is working..."):
        try:
            ...
            final_report = raw_content[0]['text'] if isinstance(raw_content, list) else str(raw_content)
